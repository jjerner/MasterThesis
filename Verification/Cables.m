...
for iCode = 1:height(LineCodes)
    ...
    reactance1 = LineCodes.X1(iCode);
    resistance0 = LineCodes.R0(iCode);
    reactance0 = LineCodes.X0(iCode);
    ...
    for iLine = 1:height(Lines)
       ...
       if currentName == Lines.LineCode(iLine)
            ...
            CableData(iLine).Xpl    = reactance1;
            CableData(iLine).X0pl   = reactance0;
            CableData(iLine).XNpl   = reactance1;
